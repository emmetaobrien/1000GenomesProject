...
## Output
ALL.chrMT.phase3_callmom.20130502.genotypes.vcf.gz

## Post-processing
VCF was compressed using bgzip, indexed using tabix, and validated using vcf-validator

## update on 2016-02-01
The file 1KG_No_Het.fasta can be found at ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/supporting/MT/chrMT_sequences_2534.20160101.fasta.gz
